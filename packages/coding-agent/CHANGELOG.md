...
- Added Presets intro cards in Settings (Tools) that show each capability pack's source and maturity, and apply the pack to unconfigured keys (tool changes take effect when the session next starts).
